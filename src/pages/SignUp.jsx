            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-center justify-between text-sm text-gray-400">
                <label className="flex items-center space-x-2">
                  <input type="checkbox" className="form-checkbox h-4 w-4 text-cineflix rounded" />
              ...
              <button
                type="submit"
                className="w-full bg-cineflix text-white py-4 rounded text-lg font-semibold hover:bg-red-700 transition"
              >
                {isLogin ? 'Sign In' : 'Sign Up'}
              </button>
            </form>
